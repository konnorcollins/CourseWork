 ...
 */
public class Column implements Glyph, Composition {
	...
	public Column(String[] strings, Window window) {
		...
		for (int i = 0; i < strings.length; i++)
			add(new Row(strings[i], window), i);
	...
	/**
	 * Creates a Column composite containing the given Glyphs.
	 * @param glyphs
	 * @param window
	 */
	public Column(Glyph[] glyphs, Window window) {
		_window = window;
		_children = new ArrayList<Glyph>();
